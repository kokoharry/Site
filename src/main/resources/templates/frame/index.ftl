...
<head>
    ...
    <title>Kokoharry Private Site</title>
    <!-- Bootstrap Styles-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><strong><i class="icon fa fa-plane"></i> BRILLIANT</strong></a>
                <div id="sideNav" href="">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                <div>
                    <h2><small>欢迎 ${user.realName}</small></h2>
                </div>
                </li>
                <li class="dropdown">
...
">${m.menuName}
        ...
        <!-- /. NAV SIDE  -->
        <div id="page-wrapper">
            <iframe id="innerPage" name="innerPage" src="/login/mainPage"  width="100%" height="1000px" frameborder="0"
                    scrolling="no"
                    style="border:0px;"/>
        </div>
</body>
